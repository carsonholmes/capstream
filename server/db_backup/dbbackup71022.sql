...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `hub` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
...
INSERT INTO `category` VALUES (101,4,2,'Automotive',4,_binary '�Z?�2��',_binary '\0'),(102,4,2,'Animals',4,_binary '�Z?�2��',_binary '\0');
...
CREATE TABLE `message` (
  ...
  `idThread` bigint(20) unsigned NOT NULL,
...
CREATE TABLE `offer` (
  ...
  `confirmMethod` tinyint(4) NOT NULL,
  `price` float NOT NULL,
  `rateType` smallint(6) NOT NULL,
  `negotiable` tinyint(4) NOT NULL,
  `maxTimeIncrement` smallint(6) DEFAULT NULL,
  `startTimeIncrement` smallint(6) DEFAULT NULL,
  `bookingLeadNumber` smallint(6) DEFAULT NULL,
  `bookingLeadType` tinyint(4) DEFAULT NULL,
  `cancelLeadNumber` smallint(6) DEFAULT NULL,
  `cancelLeadType` tinyint(4) DEFAULT NULL,
  `cancelFee` float DEFAULT NULL,
  `quantify` bit(1) DEFAULT NULL,
  `quantity` smallint(6) NOT NULL,
  `minTimeIncrement` smallint(6) DEFAULT NULL,
  `handlePayment` bit(1) NOT NULL,
  `depositRequired` tinyint(4) NOT NULL,
  `cancelPolicyOn` bit(1) NOT NULL,
  `cancelFeeType` tinyint(4) DEFAULT NULL,
  `depositAmountType` tinyint(4) DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  `userTimeZone` tinyint(4) NOT NULL,
  PRIMARY KEY (`idEntity`),
  UNIQUE KEY `idEntity_UNIQUE` (`idEntity`),
...
-- Dump completed on 2022-07-10 19:30:04
